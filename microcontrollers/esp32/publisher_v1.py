...
class Publisher: #full ESP32 publisher 
    ...
    def __init__(self, ru=1, max_lim=10000): #init of data pts. 
        ...
        self.server="192.168.192.20" #MQTT server addr ##check from rpi4 address by hostname -I in terminal
        ...
        while True:
            ...
            try:
                ...
                if self.lit_level==0: #method of light up
                    ...
                    self.decide_color(w)
                    print("LED System 0 on.")
                    
                else:

                    self.decide_level(w)
                    print("LED System 1 on.")
            ...
            if self.lit_level==0:
                ...
                self.turn_off_blink(self.blue_pin)
                self.turn_off_blink(self.green_pin) #state reset
                self.turn_off_blink(self.last_pin) #extra
                print("LED System 1 off.")
...
if __name__ == "__main__": #runs full class
    ...
    #end 
    #/! Run thru thonny, while rpi4 runs thru ssh terminal run
